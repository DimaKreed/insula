...
/**
 * The island's playable sentences, in study order. Only rows with audio: the
 * player and the offline download both need a URL to work with, and a sentence
 * still waiting for TTS simply joins the playlist once it has one.
 */
